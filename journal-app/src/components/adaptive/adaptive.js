...
export default function AdaptiveCards() {
  ...
  const handleNext = () => {
    ...
    router.push(
      `${cardData[selectedIndex].route}?name=${encodeURIComponent(name)}`,
    );
  };
    ...
    >
      ...
      <IconButton
        ...
        sx={{
          ...
          boxShadow:
            selectedIndex !== null ? "0 6px 25px rgba(139,115,85,0.4)" : "none",
          "&:hover": {
            backgroundColor: selectedIndex !== null ? "#6b5335" : "#ccc",
            transform:
              selectedIndex !== null ? "scale(1.15) translateY(-3px)" : "none",
            boxShadow:
              selectedIndex !== null
